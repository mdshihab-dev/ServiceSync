...
const Card = ({ preIcon, posIcon, value, title, percent,faild }) => {
  ...
  return (
    <div className={`color-card-bg p-3  md:p-6 rounded-[10px] md:rounded-[16px] flex md:flex-row flex-col-reverse gap-2 font-inter items-center md:items-start text-center md:text-start justify-between`}>
